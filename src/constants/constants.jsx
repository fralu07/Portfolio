...
export const WHY_ME_TEXT = (
    <div className=" ">
        <p className="">
            Die prodyna sollte mich einstellen, weil ich durch meine unternehmerische Erfahrung strukturiert, organisiert arbeite, flexibel und lernbereit bin.
            ...
            Ich mag nicht alles wissen, aber ich bin strebsam, diszipliniert und bereit, gemeinsam mit der prodyna die Zukunft mitzugestalten.<br />
